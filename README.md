...
My name is Filip, I am a software developer based in Kraków area, with 2+ years of commercial backend Java experience.  [Portfolio page](https://philbjern.github.io/portfolio) 
...
- [`react-shopping-cart`](https://shoppingcartfb.netlify.app/shop) React online store application

- [`todo-list`](https://philbjern.github.io/todo-list/) fullstack task management demo app, backend written in Java with Spring and MongoDB, front was created using Svelte
...
- [`tts-client`](https://github.com/philbjern/ttss-client) command line interface for Kraków public transport information API written in Python
...
Interactive course on PostgreSQL databases and bash scripting and Git version management system. This repo includes few individual projects which were required to claim this certification.
...
### Foundations
* HTML foundations [Recipes](https://github.com/philbjern/odin-project/tree/main/foundations/03-html-foundations/PROJECT-recipes)
* Flexbox [Landing Page](https://github.com/philbjern/odin-project/tree/main/foundations/05-flex/00-PROJECT-landing-page)
* [Rock Paper Scissors](https://github.com/philbjern/odin-project/tree/main/foundations/06-javascript/00-PROJECT-rock-paper-scissors)
* [Etch-a-Sketch](https://github.com/philbjern/odin-project/tree/main/foundations/06-javascript/00-PROJECT-etch-a-sketch)
